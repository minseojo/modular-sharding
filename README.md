...
- **결과**
    ...
    - 커버링 인덱스가 적용된 경우 드를 1개에서 2개로 늘려 최대 1.4배 성능 향상, 샤드를 1개에서 3개로 늘려 최대 1.5배 성능 향상
    - 인덱스 레인지 스캔만 적용된 경우 샤드를 1개에서 2개로 늘렸을 때 최대 1.58배 성능 향상, 샤드를 1개에서 3개로 늘려 최대 2배 성능 향상
